...
"></path>
          ...
          <button onClick={handleAppleSignIn} className="oauth-button apple dark">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-apple apple-icon" viewBox="0 0 16 16" aria-hidden="true">
